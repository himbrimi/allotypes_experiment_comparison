...
# ── 5. Note on asterisked traits ─────────────────────────────────────────────
# Traits marked * (S, B, AntennaryF, M) are affected by glycoform discrepancies
# between EXP02 and EXP03. Absolute values are not directly comparable across
# experiments; directional biases are documented in project_instructions.md Step 1.
